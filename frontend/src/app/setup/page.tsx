...
export default function SetupPage() {
  ...
  const languageOptions: Language[] = browserLanguage === 'es' ? ['es', 'pt', 'en', 'th'] : browserLanguage === 'pt' ? ['pt', 'es', 'en', 'th'] : browserLanguage === 'th' ? ['th', 'en', 'es', 'pt'] : ['en', 'es', 'pt', 'th'];
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {languageOptions.map((option) => {
                    ...
                    const label = option === 'es' ? t('setup.languageSpanish') : option === 'pt' ? t('setup.languagePortuguese') : option === 'th' ? t('setup.languageThai') : t('setup.languageEnglish');
                    return (
                      <button
                        key={option}
